    ...
    while True : 
        ...
        while True:
            try : 
                ...
                if choix == "1":
                    ...
                    raise ValueError ("Votre saisie n'est pas correcte veuillez entrer un nombre entre 1 et 5!\n")
        ...
        while True : 
            ...
            if suite =="oui":
                ...
                print("Votre saisie n'est pas correcte veuillez répondre par 'oui' ou 'non'\n")
